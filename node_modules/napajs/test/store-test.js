...
describe('napajs/store', function () {
    ...
    it('@napa: store.get', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, napaZone.execute('./napa-zone/test', "getStoreTest")];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('simple types: set in node, get in napa', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    store1.set('b', 'hi');
                    return [4 /*yield*/, napaZone.execute('./napa-zone/test', "storeVerifyGet", ['store1', 'b', 'hi'])];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('simple types: set in napa, get in napa', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, napaZone.execute('./napa-zone/test', "storeSet", ['store1', 'c', 1])];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, napaZone.execute('./napa-zone/test', "storeVerifyGet", ['store1', 'c', 1])];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    var unicodeStr = "中文 español deutsch English हिन्दी العربية português বাংলা русский 日本語 ਪੰਜਾਬੀ 한국어 தமிழ் עברית";
    var store2 = napa.store.create('store2');
    it('unicode string: set in node, get in node', function () {
        store2.set('a', unicodeStr);
        assert.equal(store2.get('a'), unicodeStr);
    });
    it('unicode string: set in node, get in napa', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    store2.set('b', unicodeStr);
                    return [4 /*yield*/, napaZone.execute('./napa-zone/test', "storeVerifyGet", ['store2', 'b', unicodeStr])];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('unicode string: set in napa, get in napa', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, napaZone.execute('./napa-zone/test', "storeSet", ['store2', 'c', unicodeStr])];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, napaZone.execute('./napa-zone/test', "storeVerifyGet", ['store2', 'c', unicodeStr])];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('unicode string: set in napa, get in node', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, napaZone.execute('./napa-zone/test', "storeSet", ['store2', 'd', { a: 1, b: unicodeStr }])];
                case 1:
                    _a.sent();
    ...
    it('transportable types: set in node, get in napa', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    store1.set('b', napa.memory.defaultAllocator);
                    return [4 /*yield*/, napaZone.execute('./napa-zone/test', "storeVerifyGet", ['store1', 'b', napa.memory.defaultAllocator])];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    // We have to compare handle in this case, since napa.memory.defaultAllocator retrieved from napa zone will have 2+ refCount.
                    _a.sent();
                    return [4 /*yield*/, napaZone.execute('./napa-zone/test', "storeGetCompareHandle", ['store1', 'e', napa.memory.defaultAllocator.handle])];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('function type: set in node, get in napa', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    store1.set('h', function () { return 0; });
                    return [4 /*yield*/, napaZone.execute('./napa-zone/test', "storeVerifyGet", ['store1', 'h', function () { return 0; }])];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('function type: set in napa, get in napa', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, napaZone.execute('./napa-zone/test', "storeVerifyGet", ['store1', 'i', function () { return 0; }])];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('delete in node, check in napa', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    assert(store1.has('b'));
                    store1.delete('b');
                    return [4 /*yield*/, napaZone.execute('./napa-zone/test', "storeVerifyNotExist", ['store1', 'b'])];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('delete in napa, check in napa', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, napaZone.execute('./napa-zone/test', "storeVerifyNotExist", ['store1', 'c'])];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
