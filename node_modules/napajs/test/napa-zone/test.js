...
function broadcastSync(id, code) {
    var zone = napa.zone.get(id);
    zone.broadcastSync(code);
}
exports.broadcastSync = broadcastSync;
...
function broadcastSyncTestFunction(id) {
    napa.zone.get(id).broadcastSync(function (input) {
        console.log(input);
    }, ["hello world"]);
}
exports.broadcastSyncTestFunction = broadcastSyncTestFunction;
...
exports.executeWithArgsContainingUnicodeString = executeWithArgsContainingUnicodeString;
...
var CanAutoPass = /** @class */ (function (_super) {
    __extends(CanAutoPass, _super);
    function CanAutoPass(data) {
        var _this = _super.call(this) || this;
        _this._data = data;
        return _this;
    }
    CanAutoPass = __decorate([
        napa.transport.cid()
    ], CanAutoPass);
    return CanAutoPass;
}(napa.transport.AutoTransportable));
exports.CanAutoPass = CanAutoPass;
...
function jsAutoTransportTest() {
    testMarshallUnmarshall(new CanAutoPass({ a: 'foo', b: 'bar', c: 123 }));
}
exports.jsAutoTransportTest = jsAutoTransportTest;
