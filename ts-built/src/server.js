...
var Game = require("./Game/Game.ts");
var Player = require("./Game/Player/Player.ts");
// Socket Server
var express = require("express");
var app = express();
var imp_server = require("http");
var server = imp_server.Server(app);
...
function onConnection(socket) {
    ...
    socket.on('Initialise Player', function (playerID) {
    ...
    */
    socket.on('Request Players', function (playerObj) {
        var count = 0;
